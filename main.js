...
if (studentsResult.form === 574) {
    ...
    console.log(`name:${student5.name}    marksobtained:${student5.obtainedMarks} "passed"`);
}
else if (studentsResult.form === 579) {
    console.log(`name:${student6.name}   marksobtained:${student6.obtainedMarks} "passed"`);
}
else if (studentsResult.form === 600) {
    console.log(`name:${student7.name}   marksobtained:${student7.obtainedMarks}  "passed"`);
}
else {
